...
sns.distplot(df_final_train.binary_target)
...
print 'R^2: ' + str(rfc.score(df_final_train[features], df_final_train['binary_target']))
...
preds = rfc.predict(df_final_test[features])
...
df_output[['card_id','target']].to_csv("C:/Users/Garrett/Documents/Kaggle/Elo/submissions/submission_9.csv", index=False)
